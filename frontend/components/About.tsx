      ...
      >
        <div className='flex flex-col gap-5 text-xl text-[#E7E7E6] md:w-2/3'>
          ...
          <p className='text-right text-lg'>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Assumenda dolorem, at obcaecati
            modi fugiat itaque ad odit quidem porro! Officiis reiciendis exercitationem minima, quas
            cumque consequatur at nisi sit omnis.
          </p>
          {isLearnMoreOpen && (
            <div>
              <p className='w-3/4 text-left text-lg'>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda dolorem, at
                obcaecati modi fugiat itaque ad odit quidem porro! Officiis reiciendis
                exercitationem minima, quas cumque consequatur at nisi sit omnis.
              </p>
            </div>
          )}
          <p
